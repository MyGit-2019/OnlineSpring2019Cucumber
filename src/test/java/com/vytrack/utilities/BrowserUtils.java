...
public class BrowserUtils {
    ...
    public static String getScreenshot(String name) {
        ...
        //if screenshot does not work i will try below
        //String target = System.getProperty("C:\Users\rozi_\OnlineVYTrackAutomationTestNG) + "/test-output/Screenshots/" + name + date + ".png";
